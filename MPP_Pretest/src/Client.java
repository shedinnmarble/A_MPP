...
public class Client {
	...
	public static void main(String[] args) {
		...
		Role role1 = new Role();
		role1.setRoleType(Role.RoleType.ProjectManager);
		Role role2 = new Role();
		role2.setRoleType(Role.RoleType.Developer);
		roleList.add(role1);
		roleList.add(role2);
		pm.changeRole(roleList);
		...
		for (Employee employee : employees) {
			...
			for (Role role : employee.roleList) {
				System.out.println("Role Name:" + role.getRoleType().toString());
			}
